...
@Component({
  selector: 'app-image-gsheet',
  templateUrl: './imageToGsheet.component.html',
  styleUrls: ['./imageToGsheet.component.css']
})
export class ImageToGsheetComponent implements OnInit {
